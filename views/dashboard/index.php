...
<main class="dashboard-main">
  <div class="d-flex justify-content-between align-items-center mb-4">
    <h3 class="fw-bold mb-0">Welcome Back, <span class="text-primary">Teacher!</span></h3>
  </div>
      ...
      <div class="card shadow-sm h-100">
        <div class="card-body">
          ...
          <div class="d-grid gap-2">
            ...
            <button class="btn btn-light border text-start"><i class="bi bi-journal-bookmark me-2"></i>Manage Courses</button>
